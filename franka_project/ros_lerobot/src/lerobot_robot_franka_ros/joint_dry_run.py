"""Non-actuating fixture source and JSONL action sink for the joint-space policy."""
...
from .joint_contract import JointDryRunObservation, load_joint_dry_run_observation


class JointDryRunBackend:
    ...
    def __init__(self, *, fixture_path: Path | None, action_log_path: Path | None, robot_id: str | None):
        ...
        self._fixture: JointDryRunObservation | None = None
    ...
    def connect(self) -> None:
        ...
        fixture = load_joint_dry_run_observation(self.fixture_path)
